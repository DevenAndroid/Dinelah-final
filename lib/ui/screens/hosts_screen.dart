  ...
  void initState() {
    ...
    scrollController.addListener(() {
      if (scrollController.position.maxScrollExtent ==
        ...
        _controller.getHostData(context).then((value){setState(() {
        });});
      }
    });
  }
          ...
          return Padding(
            ...
            child: CustomScrollView(
              ...
              slivers: <Widget>[
                  ...
                  delegate: SliverChildBuilderDelegate(
                      ...
                      return Padding(
                        ...
                        child: Obx(() {
                          return ItemProduct(
                              _controller,
                              _controller.model.value.data!.storeProducts,
                              index,
                              itemHeight,
                              false);
                        }),
                    ...
                    childCount: _controller.model.value.data!.storeProducts
                        .length,
                  ),
                ),
                SliverToBoxAdapter(
                  child: Container(
                    ...
                    height: 80,
                    child: _controller.allLoaded.value
                ...
                //   // sliver: _controller.allLoaded.value
