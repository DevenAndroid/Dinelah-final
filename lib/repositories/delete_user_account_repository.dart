...
Future<ModelResponseCommon> deleteUserAccountData(BuildContext context) async {
  ...
  http.Response response = await http.post(Uri.parse(ApiUrls.deleteUserAccountUrl),
